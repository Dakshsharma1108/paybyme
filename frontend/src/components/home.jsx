...
export function PayByMeHome() {
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-100 to-white overflow-auto"
      style={{ overflow: "auto" }}
    >
      {/* Hero Section */}
      <section className="w-full py-20 text-center px-4 animate-fade-in">
        ...
        <p className="mt-4 text-lg text-gray-700 animate-fade-in delay-400 max-w-xl mx-auto">
      ...
      {/* Features Section */}
      <section className="py-20 bg-white/80 px-4 animate-fade-in delay-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center p-6 bg-indigo-50 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 text-center">
                Send and receive money in seconds, anytime, anywhere.
              </p>
            </div>
            <div className="flex flex-col items-center p-6 bg-indigo-50 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              <span className="text-4xl mb-4">🔒</span>
            ...
            <div className="flex flex-col items-center p-6 bg-indigo-50 rounded-lg shadow-md hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 text-center">
                A simple, intuitive interface for everyone. No learning curve.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="py-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-center animate-fade-in delay-1000">
        <p className="text-sm">
          &copy; {new Date().getFullYear()} PayByMe. All rights reserved.
        </p>
      </footer>
    </div>
  );
